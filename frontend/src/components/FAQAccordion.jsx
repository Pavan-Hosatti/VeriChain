...
const faqData = [
    ...
    },
    {
        ...
        a: 'Absolutely. Your credentials are verified through cryptographic proofs on-chain. VeriChain never stores raw academic data — only signed verification hashes that cannot be tampered with.',
    },
    {
        q: 'Can credentials be revoked?',
        a: 'Yes. Issuing institutions can revoke credentials at any time by updating the on-chain record. VeriChain continuously checks revocation status during every verification.',
    },
    {
...
const FAQAccordion = () => {
    ...
    return (
        <section className="faq-section">
            ...
            <p className="faq-subheading">Everything you need to know about VeriChain.</p>
