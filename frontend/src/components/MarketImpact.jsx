...
const MarketImpact = () => {
    const highlights = [
        ...
        },
        {
            ...
            desc: 'Eliminate the $50+ fee for manual registrar checks. Seal It scales verification costs to near-zero.'
        },
        {
    ...
    return (
        <section className="cv-market-impact">
            <div className="cv-section-header">
                <span className="cv-badge cv-badge-primary">WHY SEAL IT?</span>
